...
```
git clone https://gitflic.ru/project/marina27812024/sozdanie-saita-otdela.git
cd sozdanie-saita-otdela
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/marina27812024/sozdanie-saita-otdela.git
git clone
